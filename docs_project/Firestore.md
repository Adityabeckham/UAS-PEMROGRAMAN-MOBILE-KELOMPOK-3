...
Sesuai standar keamanan, berikut aturan dasar yang wajib diterapkan pada Firebase Console agar peserta tidak dapat memanipulasi data nilai. Aturan ini memisahkan hak akses antara proses membaca, memperbarui data yang ada, dan membuat data baru:
