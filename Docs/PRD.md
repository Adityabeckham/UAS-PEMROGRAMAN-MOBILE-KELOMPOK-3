...
| F04 | Sesi Tes | Sebagai Peserta, saya ingin menjawab soal agar proses assessment berjalan. | P0 |
| F05 | Monitoring Real-time | Sebagai Klien, saya ingin melihat progres tes peserta secara langsung. | P1 |
| F06 | Laporan Hasil | Sebagai Klien, saya ingin mengunduh laporan hasil tes peserta. | P2 |
